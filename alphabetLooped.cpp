...
int main ()
{
	...
	int count = 1; // Defines a count for the loop
		...
		cout << "Enter ten characters to be translated through the" << endl; 			// An instruction statement
		cout << "International Civil Aviation Organization alphabet words. " << endl;
		cout << "(Blanks count as characters. Symbols are not recognized.)" << endl;
		while (count <= 10) // Limits the count to 10
		{
